...
$('.checkpoint1').css('left',((1-(track2+track3)/total)*100)+'%');$('.checkpoint2').css('left',((1-(track3)/total)*100)+'%');ig.input.bind(ig.KEY.LEFT_ARROW,'left');ig.input.bind(ig.KEY.RIGHT_ARROW,'right');ig.input.bind(ig.KEY.UP_ARROW,'jump');ig.input.bind(ig.KEY.SPACE,'jump');ig.input.bind(ig.KEY.ENTER,'ok');ig.input.bindTouch('#btn-left','left');ig.input.bindTouch('#btn-right','right');ig.input.bindTouch('#btn-jump','jump');ig.input.bindTouch('#btn-start','ok');ig.music.add(sound1,'first');ig.music.add(sound2,'second');ig.music.add(sound3,'third');ig.music.loop=true;$('.win').fadeOut('slow');$('.death').fadeOut('slow');if(!soundEnabled){ig.music.volume=0;}
